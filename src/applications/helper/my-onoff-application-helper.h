...
#ifndef MY_ONOFF_APPLICATION_HELPER_H
#define MY_ONOFF_APPLICATION_HELPER_H
...
public:
  /**
   * Create an MyOnOffHelper to make it easier to work with OnOffApplications
   *
...
#endif /* MY_ONOFF_APPLICATION_HELPER_H */
